...
<body>
  ...
  <div class="content">
    ...
    <table id="reportTable">
      ...
      <tbody>
        <tr>
          <td>{{ $incomingInventory->supplier }}</td>
          <td>{{ $incomingInventory->inventory->id }}</td>
          <td>{{ $incomingInventory->inventory->name }}</td>
          <td>{{ \Carbon\Carbon::parse($incomingInventory->received_at)->format('d F Y') }}</td>
        </tr>
      </tbody>
    </table>
  </div>
