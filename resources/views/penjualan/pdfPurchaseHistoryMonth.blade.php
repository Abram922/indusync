...
<body>
  ...
  <div class="content">
    ...
    <table id="reportTable">
      ...
      <tbody>
        @foreach ($purchase as $inventory)

        <tr>
          <td>{{ $inventory->inventory->id ?? 'Tidak ada' }}</td>
          <td>{{ $inventory->inventory->name ?? 'Tidak ada' }}</td>
          <td>{{ $inventory->supllier }}</td>
          <td>{{ $inventory->quantity }}</td>
          <td>{{ $inventory->tanggalPembelian }}</td>
          <td>{{ $inventory->tanggalPengiriman }}</td>
          <td>{{ $inventory->status->status ?? 'Tidak ada' }}</td>
          <td>{{ $inventory->resi }}</td>
        </tr>
        @endforeach 
      </tbody>
    </table>
